...
class TableContainerLunch extends StatefulWidget {
  const TableContainerLunch({
    Key? key,
  ...
  @override
  State<TableContainerLunch> createState() => _TableContainerLunchState();
}

class _TableContainerLunchState extends State<TableContainerLunch> {
                ...
                child: TextButton(
                  ...
                  onPressed: isButtonDisable
                      ...
                      : () => setState(() {
                            ...
                            _isTableSnackBeforeDinner = true;
