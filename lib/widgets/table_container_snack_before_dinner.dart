...
class TableContainerSnackBeforeDinner extends StatefulWidget {
  const TableContainerSnackBeforeDinner({
    Key? key,
  ...
  @override
  State<TableContainerSnackBeforeDinner> createState() =>
      _TableContainerSnackBeforeDinnerState();
}

class _TableContainerSnackBeforeDinnerState
    extends State<TableContainerSnackBeforeDinner> {
